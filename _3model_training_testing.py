...
// May 2, 2024
//
// Description: This file is used to train the neural network model using the selected features and evaluate the model on the test set.
//
//********************************************************************
"""
import numpy as np
...
def main():
    ...
    print("Error on test set:", round(test_eval[0], 3))
